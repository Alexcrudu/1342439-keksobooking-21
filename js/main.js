...
// let mainPinLeft = 570;
// let mainPinTop = 375;
// const roomsNummber = window.map.form.querySelector('#room_number');
// const guestsNummber = window.map.form.querySelector('#capacity');
// const titleInput = window.map.form.querySelector('#title');
// const MIN_TITLE_LENGTH = 30;
// const MAX_TITLE_LENGTH = 100;
// const timeinInput = window.map.form.querySelector('#timein');
// const timeoutInput = window.map.form.querySelector('#timeout');
// const priceInput = window.map.form.querySelector('#price');
// const typaInput = window.map.form.querySelector('#type');
